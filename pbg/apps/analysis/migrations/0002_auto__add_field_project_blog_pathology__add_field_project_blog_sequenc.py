...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('analysis_project', 'blog_pathology',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='blog_pathology', unique=True, null=True, to=orm['comments.Blog']),
                      keep_default=False)

        # Adding field 'Project.blog_sequencing'
        db.add_column('analysis_project', 'blog_sequencing',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='blog_sequencing', unique=True, null=True, to=orm['comments.Blog']),
                      keep_default=False)

        # Adding field 'Project.blog_fastq'
        db.add_column('analysis_project', 'blog_fastq',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='blog_fastq', unique=True, null=True, to=orm['comments.Blog']),
                      keep_default=False)

        # Adding field 'Project.blog_bam'
        db.add_column('analysis_project', 'blog_bam',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='blog_bam', unique=True, null=True, to=orm['comments.Blog']),
                      keep_default=False)

        # Adding field 'Project.blog_metric'
        db.add_column('analysis_project', 'blog_metric',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='blog_metric', unique=True, null=True, to=orm['comments.Blog']),
                      keep_default=False)

        # Adding field 'Project.blog_vcf'
        db.add_column('analysis_project', 'blog_vcf',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='blog_vcf', unique=True, null=True, to=orm['comments.Blog']),
                      keep_default=False)
