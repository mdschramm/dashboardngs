...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('core_userprofile_projects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['core.userprofile'], null=False)),
            ('project', models.ForeignKey(orm['analysis.project'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'project_id'])

        # Adding M2M table for field studies on 'UserProfile'
        m2m_table_name = db.shorten_name('core_userprofile_studies')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['core.userprofile'], null=False)),
            ('study', models.ForeignKey(orm['projects.study'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'study_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('core_userprofile_projects'))

        # Removing M2M table for field studies on 'UserProfile'
        db.delete_table(db.shorten_name('core_userprofile_studies'))
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'projects': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['analysis.Project']", 'null': 'True', 'blank': 'True'}),
            'studies': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['projects.Study']", 'null': 'True', 'blank': 'True'}),
